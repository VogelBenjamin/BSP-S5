...
solver1.setType('preonly')#solver1.setType(PETSc.KSP.Type.BCGS)
pc1 = solver1.getPC()
pc1.setType('lu')#pc1.setType(PETSc.PC.Type.JACOBI)

# Solver for step 2
solver2 = PETSc.KSP().create(mesh.comm)
solver2.setOperators(A2)
solver2.setType('preonly')#solver2.setType(PETSc.KSP.Type.MINRES)
pc2 = solver2.getPC()
pc2.setType('lu')#pc2.setType(PETSc.PC.Type.HYPRE)
#pc2.setHYPREType("boomeramg")

# Solver for step 3
solver3 = PETSc.KSP().create(mesh.comm)
solver3.setOperators(A3)
solver3.setType('preonly')#solver3.setType(PETSc.KSP.Type.CG)
pc3 = solver3.getPC()
pc3.setType('lu')#pc3.setType(PETSc.PC.Type.SOR)
